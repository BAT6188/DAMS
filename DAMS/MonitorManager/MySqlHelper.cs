    ...
    public abstract class MySqlHelper
    {
        ...
        private static string GetConnectionStr()
        {
            if (_connectionString == "")
            {
                ...
                string dataBaseName = ini.ReadValue("DbServer", "sSID");
                string userId = ini.ReadValue("DbServer", "sUID");
                string password =  ini.ReadValue("DbServer", "sPWD");
                string dataSource = ini.ReadValue("DbServer", "sIP");
                _connectionString = "Database='" + dataBaseName + "';";
                _connectionString += "Data Source='" + dataSource + "';User Id='" + userId + "';";
                _connectionString += "Password='" + password + "';charset='utf8';pooling=true";
            }
        ...
        public static int ExecuteNonQuery(string connectionString, CommandType cmdType, string cmdText, params MySqlParameter[] commandParameters)
        {
            ...
            cmd.CommandType = CommandType.StoredProcedure;//指明使用的是存储过程
            cmd.CommandText = "sysLogin";
